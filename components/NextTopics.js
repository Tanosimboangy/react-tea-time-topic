...
export default function NextTopics({ nextTopic, topics }) {
    ...
    // const [nextTopicArchive, setNextTopicArchive] = useState();
                ...
                <li className="nexttopicVotes">
                    <ul>
                        <li>
                            <ul>
                                <li>
                                <button onClick={() => setNextTopicUpvotes(nextTopicUpvotes + 1)}>
                        ...
                        <li>
                            <ul>
                                ...
                                <li style={{marginLeft:'1rem'}}> 
                                    <button onClick={() => setNextTopicDownvotes(nextTopicDownvotes - 1)}>
